class Payment < ActiveRecord::Base
  attr_accessible :total_home_cost, :property_tax_rate, :home_insurance_rate, :loan_length, :down_payment,
                  ...
                  :pmi_needed, :piti, :total_home_cost, :principal_interest, :prop_insurance, :mortgage_insurance,
                  :house_monthly_debt, :closing_costs, :total_debt_income_ratio, :suggested_cash
